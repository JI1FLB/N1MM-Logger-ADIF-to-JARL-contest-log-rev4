def phase3( call:str , Contest_name:str, QSLyesno, JST_convert_flag, Power_code, Multi, AA_contest, Remarks1, path ):
    ...
    log_file = path + "/" + Callsign + "_logsheet.txt"
    csv_file = path + "/" + Callsign + "_csv.txt"
    jarl_file = path + "/" + Callsign + ".txt"
    summary_file = path + "/" + Callsign + "_summary.txt"
    HL_file = path + "/" + Callsign + ".csv"
